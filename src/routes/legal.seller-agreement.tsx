...
export const Route = createFileRoute("/legal/seller-agreement")({
  head: () => ({ meta: [{ title: "Seller Agreement — HUXZAIN" }] }),
  component: () => (
    <LegalPage title="Seller Agreement" eyebrow="Vendor Terms">
      <p>This Seller Agreement governs your participation as a vendor on the HUXZAIN platform.</p>
      ...
      <p>HUXZAIN collects a 10% platform commission on completed sales (configurable by category and plan). Payouts are released to your linked method after the dispute window closes.</p>
